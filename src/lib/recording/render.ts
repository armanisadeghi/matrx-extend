 ...
 */
import { type GifFrameInput, encodeGif } from '@/lib/recording/gif-encoder';
import type { RecordedEvent, RecordingState } from '@/lib/recording/state';
