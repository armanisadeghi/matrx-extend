...
- Privacy → "Offer saved logins on sign-in forms" (`offerSavedLoginsEnabled`, default ON) gates metadata-only focused-field matching. A user click is required before materialization/fill; it never submits a form.
