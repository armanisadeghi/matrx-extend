  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* Settings → Default agent renders THE ONE agent picker, so the options
          page needs the same catalog and tooltip provider the side panel mounts. */}
      <TooltipProvider delayDuration={150}>
        <AgentCatalogProvider catalog={getAgentCatalog()}>
          <div className="mx-auto max-w-2xl py-8">
            <h1 className="mb-6 px-3 text-2xl font-semibold tracking-tight">
              Matrx Extend Settings
            </h1>
            <SettingsView />
          </div>
