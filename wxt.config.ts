...
export default defineConfig({
  ...
  manifest: ({ mode }) => ({
    ...
    // Inline saved-login writes target a browser documentId. Chrome 106 is
    // the first supported version for that binding; do not advertise a lower
    // capability floor than the API contract.
