...
const { inspectIdentity, sameLifecycleIdentity, runExtensionReload, visibleSettingsControl, visibleVaultControl } = require('./vault-extension-lifecycle-acceptance.cjs');
