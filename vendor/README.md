...
machine and nowhere else (CI, cloud agent sessions, a fresh clone). A committed
...
```bash
cd ../aidream/apps/shared/content-ir-react && pnpm pack --pack-destination ../../../../matrx-extend/vendor
```
