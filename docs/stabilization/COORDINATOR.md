...
- ACTIVE sole guarded workload seo-guest-009 wrapper43784, `/tmp/matrx-seo-guest-009.log`, launched19:04UTC. Next: confirm wrapperexit, preserve receipt, diagnose exactcomparison; iffailseconsecutive actualattempt decompose/reroute perthreshold, no unchangedretry. Nootherworker currentlyrunning. Guestbuilder `/root/seo_guest_detail_build` availableforfix, ownsrunner.
