...
- Active builder `/root/seo_guest_detail_build` prepares guest-only T09 detail observations (no runtime), owns guest runner/prep report; fresh sourcepeer required before root guarded seo-guest-008. PrimaryChrome remains .72; owned .73 runs are separate.
