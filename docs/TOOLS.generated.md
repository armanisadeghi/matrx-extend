...
Generated: 2026-09-25T09:13:55.996Z
Total tools: 82
...
**Parameters:** `action` (string, required) = ["check_availability","summarize","classify","extract_json","translate","detect_language","proofread","describe_image","check_prompt_injection"]; `categories` (array); `image_base64` (string); `image_url` (string); `mime_type` (string); `prompt` (string); `schema` (any); `source_lang` (string); `target_lang` (string); `text` (string)
...
**Parameters:** `action` (string, required) = ["start_recording","stop_recording","export","clear"]; `coordinate` (array); `download` (boolean); `filename` (string); `options` (object); `ref` (string); `tab_id` (string, required)
...
**Parameters:** `audio` (boolean); `duration_ms` (integer); `filename` (string); `tab_id` (integer)
...
**Parameters:** `action` (string, required) = ["list","confirm","cancel","download_url"]; `download_id` (string); `filename` (string); `url` (string)
...
**Parameters:** `format` (string) = ["png","jpeg"]; `padding` (integer); `profile` (string) = ["auto","auto-final","anthropic-default","anthropic-hires","openai-original","openai-high","openai-low","gemini-screenshot","gemini-overview","gemini-2.5-default","ocr-heavy","lossless"]; `quality` (integer); `rect` (object, required); `ref` (string); `selector` (string)
...
**Parameters:** `action` (string, required) = ["search","tree"]; `folder_id` (string); `limit` (integer); `max_depth` (integer); `query` (string)
...
**Parameters:** `action` (string, required) = ["get","set","delete"]; `domain` (string); `expires_in_seconds` (integer); `http_only` (boolean); `name` (string); `path` (string); `same_site` (string) = ["strict","lax","no_restriction"]; `secure` (boolean); `url` (string, required); `value` (string)
...
**Parameters:** `action` (string, required) = ["search","recent"]; `end_time_ms` (integer); `limit` (integer); `minutes` (integer); `query` (string); `start_time_ms` (integer)
...
**Parameters:** `$variants` (any); `action` (string, required) = ["list","auto","discover","attempt","authenticator","report","capture","propose_recipe"]; `attempt_id` (string); `challenge_signals` (array); `code_selector` (string); `credential_item_id` (string); `description` (string); `display_name` (string); `expect` (object); `failure_signals` (array); `field_map` (array); `fields` (array); `host` (string); `kind` (string) = ["secret_exposed","wrong_verdict","recipe_wrong","other"]; `notes` (string); `provider_key` (string); `query` (string); `session_id` (string); `steps` (array); `submit` (any); `submit_selector` (string); `success_signals` (array); `verbose` (boolean); `where` (string)
...
**Parameters:** `action` (string) = ["preview","capture"]; `site_id` (string); `url` (string)
...
**Parameters:** `demo_id` (string, required); `dry_run` (boolean); `params` (object); `tab_id` (integer)
...
**Parameters:** `max_nodes` (integer); `tab_id` (integer)
...
**Parameters:** `action` (string, required) = ["set","clear"]; `device_scale_factor` (number); `height` (integer); `mobile` (boolean); `tab_id` (integer); `user_agent` (string); `width` (integer)
...
**Parameters:** `capture_scale` (number); `format` (string) = ["png","jpeg","webp"]; `full_page` (boolean); `profile` (string) = ["auto","auto-final","anthropic-default","anthropic-hires","openai-original","openai-high","openai-low","gemini-screenshot","gemini-overview","gemini-2.5-default","ocr-heavy","lossless"]; `quality` (integer); `tab_id` (integer)
...
**Parameters:** `button` (string) = ["left","right","middle"]; `click_count` (integer); `tab_id` (integer); `x` (number, required); `y` (number, required)
...
**Parameters:** `tab_id` (integer); `text` (string, required)
...
**Parameters:** `request_id` (string, required); `tab_id` (integer)
...
**Parameters:** `landscape` (boolean); `print_background` (boolean); `tab_id` (integer)
...
**Parameters:** `request_id` (string, required); `tab_id` (string)
...
**Parameters:** `auto_start` (boolean); `clear` (boolean); `errors_only` (boolean); `level_filter` (array); `limit` (integer); `max` (integer); `pattern` (string); `tab_id` (string)
...
**Parameters:** `auto_start` (boolean); `clear` (boolean); `include_body` (boolean); `limit` (integer); `tab_id` (string); `url_pattern` (string)
...
**Parameters:** `caption` (string); `domain` (string, required); `origin_url` (string); `text` (string, required)
...
**Parameters:** `expected_action` (string); `instructions` (string); `reason` (string, required); `tab_id` (string); `timeout_seconds` (integer)
...
**Parameters:** `approach` (array); `domains` (array); `estimated_minutes` (integer); `reasoning` (string); `steps` (array); `timeout_seconds` (integer); `title` (string)
...
**Parameters:** `actions` (array); `allow_other` (boolean); `context` (string); `header` (string); `level` (string) = ["info","success","warning","error"]; `message` (string); `options` (array); `question` (string); `questions` (array); `timeout_seconds` (integer); `type` (string) = ["confirm","choice","choice_many","text","secret","notify"]
...
**Parameters:** `action` (string, required) = ["add","list","update","remove","mark_done","clear_done"]; `context` (any); `done` (boolean); `due` (any); `id` (string); `silent` (boolean); `title` (string)
...
**Parameters:** `action` (string, required) = ["read","write"]; `text` (string)
...
**Parameters:** `action` (string, required) = ["left_click","right_click","double_click","triple_click","type","key","scroll","hover","screenshot","left_click_drag","scroll_to","focus","blur"]; `coordinate` (array); `modifiers` (string); `ref` (string); `repeat` (integer); `scroll_amount` (integer); `scroll_direction` (string) = ["up","down","left","right"]; `start_coordinate` (array); `tab_id` (string, required); `text` (string)
...
**Parameters:** `coordinate` (array); `file_id` (string, required); `filename` (string); `ref` (string); `tab_id` (string, required)
...
**Parameters:** `ref` (string, required); `tab_id` (string, required); `value` (string|number|boolean, required)
...
**Parameters:** `force` (boolean); `tab_id` (string, required); `url` (string, required)
...
**Parameters:** `action` (string, required) = ["inject","remove"]; `css` (string, required); `persistent` (boolean); `tab_id` (integer)
...
**Parameters:** `file_ids` (array, required); `ref` (string, required); `tab_id` (string, required)
...
**Parameters:** `condition` (string, required) = ["element","text","url","network_idle"]; `scroll` (boolean); `tab_id` (string, required); `target` (string); `timeout_ms` (integer)
...
**Parameters:** `domain` (string, required); `hints` (object); `note` (string)
...
**Parameters:** `body` (string, required); `cc` (array); `subject` (string, required); `to` (string, required)
...
**Parameters:** `action` (string, required) = ["list","describe","recipes","run","save","delete"]; `config` (object); `domain` (string); `fields` (array); `kind` (string) = ["manual_css","json_ld","og_meta","auto_table","next_data","ai_extract","list_pattern","microdata","network_capture"]; `name` (string); `pattern_id` (string); `rows_limit` (integer)
...
**Parameters:** `itemtype` (string); `kinds` (array); `ld_type` (string)
...
**Parameters:** `compute_header_paths` (boolean); `max_rows` (integer); `normalize` (boolean); `ref` (string); `selector` (string)
...
**Parameters:** `follow_redirects` (boolean); `include_extras` (boolean); `max_chars` (integer); `url` (string, required); `use_session` (boolean); `user_agent` (string)
...
**Parameters:** `include_content` (boolean); `limit` (integer); `max_candidates` (integer); `query` (string, required); `tab_id` (string)
...
**Parameters:** `case_sensitive` (boolean); `context_chars` (integer); `limit` (integer); `query` (string, required); `regex` (boolean); `tab_id` (string)
...
**Parameters:** `properties` (array); `selector` (string, required)
...
**Parameters:** `include_html` (boolean); `include_styles` (boolean); `ref` (string, required); `tab_id` (string)
...
**Parameters:** `href_contains` (string); `limit` (integer); `same_origin_only` (boolean); `text_contains` (string)
...
**Parameters:** `max_chars` (integer); `tab_id` (string)
...
**Parameters:** `limit` (integer); `scope` (string) = ["page","site","all"]; `url` (string)
...
**Parameters:** `duration_ms` (integer); `kinds` (array); `max_events` (integer); `ref` (string); `selector` (string)
...
**Parameters:** `attributes` (array); `limit` (integer); `selector` (string, required)
...
**Parameters:** `filter` (string) = ["interactive","all"]; `include_bounds` (boolean); `include_hidden` (boolean); `include_text` (boolean); `interactive_only` (boolean); `max_chars` (integer); `max_nodes` (integer); `tab_id` (string); `trigger_lazy_load` (boolean)
...
**Parameters:** `$variants` (any); `action` (string, required) = ["table_list","metadata_search","record_read","record_aggregate","record_write","record_delete","record_history","record_restore_version","field_propose","table_propose","form_propose","booking_propose","import_propose","dashboard_propose","pipeline_propose","document_propose","checklist_propose","capture_propose","enrich_propose","portal_propose","signature_request","subscription_propose","entity_read","entity_write"]; `availability` (object); `blocks` (array); `body` (string); `checklist_id` (string); `client_fields` (array); `client_table` (string); `client_table_id` (string); `columns` (array); `config` (object); `context_policy` (string); `csv_text` (string); `dashboard_id` (string); `date_order` (string); `dedupe_key` (string); `description` (string); `enable` (boolean); `entity` (string); `expected_version` (integer); `expires_days` (integer); `field` (string); `field_key` (string); `field_type` (string); `fields` (array); `file_hash` (string); `flow` (string); `group_by` (string); `home` (string); `id_keyed` (boolean); `intro` (string); `invite` (array); `label` (string); `letterhead` (boolean); `limit` (integer); `limits` (object); `mapping` (object); `match` (object); `measure` (string); `name` (string); `notify` (object); `on_duplicate` (string); `on_entry` (object); `open_to_crew` (boolean); `options_table_id` (string); `presentation` (object); `preview_only` (boolean); `publish` (boolean); `query` (string); `questions` (array); `record_id` (string); `records` (array); `relation_target` (string); `render_id` (string); `requires` (object); `roles` (array); `rows` (array); `run` (boolean); `sensitivity` (string); `signer_email` (string); `signer_name` (string); `source_name` (string); `spec` (object); `stage_field` (object); `start_for` (string); `steps` (array); `submission_cap` (integer); `submit_label` (string); `table` (string); `table_id` (string); `tables` (array); `tell` (array); `template_id` (string); `thank_you` (object); `title` (string); `transitions` (array); `trigger` (string); `undo` (boolean); `unit` (string); `unmapped` (string); `values` (object); `version` (integer); `view_id` (string); `view_name` (string); `watch` (object); `who` (object)
...
**Parameters:** `height` (integer, required); `tab_id` (integer); `width` (integer, required)
...
**Parameters:** `action` (string, required) = ["list","create","add","remove","update"]; `collapsed` (boolean); `color` (string) = ["grey","blue","red","yellow","green","pink","purple","cyan","orange"]; `group_id` (integer); `tab_ids` (array); `title` (string)
...
**Parameters:** `action` (string, required) = ["list","create","close","switch","reload","active","info","pin","mute","duplicate","move","zoom"]; `index` (integer); `on` (boolean); `tab_id` (string); `url` (string); `window_id` (integer); `zoom_factor` (number)
